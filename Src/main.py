...
from Src.ScrolledWindow import ScrollableFrame
...
class Base(tx.Tk):
    ...
    def view_test(self):
        ...
        if len(self.treeview_3.focus())!=0:
            ...
            print(self.treeview_3.item(self.focus_item),"What the heck")
        ...
        self.frame_5_ref = tx.ScrolledWindow(self.frame_4, height=self.h_1, width=self.w_1, scrollbar="y")
    ...
    def show_result(self):
        ...
        if self.bool_show_result==True:
            ...
            self.answers = []
            print(self.req_test)
            print("SELECT test_questions from tests where test_id={req_test_id}".format(req_test_id=self.req_test["values"][0]))
    ...
    def attend(self):
        ...
        if self.check_time==True:
            ...
            print("bruh is this the only way out of hell : ",str(self.cur_time[0])+":"+str(self.cur_time[1]))
        ...
        if self.proceed_with_test==True and self.record_existing==False:
            print("IT MUST ENTER THIS BUT IDK WHAT HAPPENED NEVER GONNA GIVE YOU UP")
            self.attend_test()
    ...
    def event_handler_1(self,event):
        if self.check_true == False and self.warning <= 5 and event.widget == self.window_3:
            self.check_true = True
            print("It enters the if statement of the event_handler")
    def event_handler(self,event):
        print("It thereby enters")
        if self.warning>5:
        ...
        print(self.window_3.focus_get())
        print(event.widget)
        print(self.check_true)
        print(self.warning)
